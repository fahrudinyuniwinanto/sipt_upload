...
<html>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h2 style="margin-top:0px"><?php echo $button ?> Data_bermasalah </h2>
                </div>
	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="permasalahan" id="permasalahan" placeholder="Permasalahan" value="<?php echo $permasalahan; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <a href="<?php echo site_url('data_bermasalah') ?>" class="btn btn-default">Cancel</a>
	</div>
            </form>
        </div>
        </div>
