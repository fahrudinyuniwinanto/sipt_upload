            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h2 style="margin-top:0px"><?php echo $button ?>
                        <?php $prog = substr($this->session->userdata('id_program'), 0, 1)?>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="SUMBERDATA" id="SUMBERDATA"
                                        placeholder="SUMBERDATA" value="<?php echo $SUMBERDATA; ?>" readonly />
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="tahun">
                                        ...
                                        <option <?php if ($TAHUN == $i) {echo "selected";}?> value="<?=$i?>"><?=$i?>
                                        </option>
                                        <?php }?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="bulan">
                                        ...
                                        <?php for ($i = 1; $i < 13; $i++) {?>
                                        <option <?php if ($BULAN == $i) {echo "selected";}?> value="<?=$i?>">
                                            <?=str_bulan($i)?></option>
                                        <?php }?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="TGL_ENTRY" id="TGL_ENTRY"
                                        placeholder="TGL ENTRY" value="<?php echo $TGL_ENTRY; ?>" readonly />
                                </div>
